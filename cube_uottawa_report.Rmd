...
- [ ]  Case Date Imputation - use MICE instead?
...
get_date_biweekly <- function(x){
  z <- day_of_week <-  lubridate::wday(x)
  case_when(
    z %in% 1:3 ~ x + 3 - z,
    TRUE ~ x + 5 - z,
  )
...
figure_1 <- wrap_plots(fig1_timeline, fig1_swabs, fig1_co2, fig1_wifi,
           fig1_uo_ww, fig1_ott_ww) & 
  plot_layout(ncol = 1, heights = c(1))

rm(fig1_timeline, fig1_swabs, fig1_co2, fig1_wifi, fig1_uo_ww, fig1_ott_ww)
```
